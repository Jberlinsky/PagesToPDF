...
@class PagesItem, PagesApplication, PagesColor, PagesDocument, PagesWindow, PagesAttributeRun, PagesCharacter, PagesParagraph, PagesText, PagesAttachment, PagesWord, PagesCapturedPage, PagesLayer, PagesMasterPage, PagesPage, PagesPageSetup, PagesSection, PagesSelectionObject, PagesGraphic, PagesChart, PagesImage, PagesImageBinary, PagesLine, PagesShape, PagesTable, PagesTextBox, PagesCharacterStyle, PagesInsertionPoint, PagesListLevel, PagesListStyle, PagesParagraphStyle, PagesTableAttachment, PagesPrintSettings;
...
typedef enum PagesSavo PagesSavo;
...
typedef enum PagesPPgO PagesPPgO;
...
typedef enum PagesTPNK PagesTPNK;
...
typedef enum PagesTSPK PagesTSPK;
...
typedef enum PagesTARU PagesTARU;
...
typedef enum PagesTDST PagesTDST;
...
typedef enum PagesTDwP PagesTDwP;
...
typedef enum PagesTLEp PagesTLEp;
...
typedef enum PagesTWFt PagesTWFt;
...
typedef enum PagesTIFT PagesTIFT;
...
typedef enum PagesKCct PagesKCct;
...
typedef enum PagesTFTp PagesTFTp;
...
typedef enum PagesTLig PagesTLig;
...
typedef enum PagesTStk PagesTStk;
...
typedef enum PagesTUnd PagesTUnd;
...
typedef enum PagesTLST PagesTLST;
...
typedef enum PagesTCap PagesTCap;
...
typedef enum PagesTLbT PagesTLbT;
...
typedef enum PagesTNmT PagesTNmT;
...
typedef enum PagesEnum PagesEnum;
